...
public class MoneyItem implements ObtainableItem {
    ...
    public MoneyItem(Context context, DTile[][] tileSetPassed, Player passedPlayer, int startX, int startY){
    ...
    public void update(){
        try {
            ...
            errorText += "MoneyItem.update() ERROR 1 -" + e.toString();
        }
    ...
    public Actor act(){
        ...
        try{
            ...
            errorText += "MoneyItem.act ERROR 1 -" + e.toString();
        }
        return null;
    }
